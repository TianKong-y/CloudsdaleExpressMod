...
public final class SmoothQuartzClient implements ClientModInitializer {
    ...
    private void sendHandshakeCommand(ClientPacketListener handler) {
        ...
        handler.sendCommand("sqm handshake");
    }

    private boolean tryInvokeSendCommand(ClientPacketListener handler, String command) {
        try {
